...
The Tumor.csv dataset details a handful of first-order features of brain tumors, which are independent descriptors of the tumor. The dataset additionally provides second-order features that provide paired information about the tumor data.
