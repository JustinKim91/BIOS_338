...
::: {.class style="color: firebrick;"}
gap_gdp \<- gap_temp %\>% mutate(gdp = gdpPercap\*pop) %\>% \# Mutate temporary vector to display total gdp filter(year ==2007) gap_gdp
:::
...
::: {.class style="color: firebrick;"}
The second argument of the rnorm function should be sd and not var. The rnorm function does not recognize the argument var.
